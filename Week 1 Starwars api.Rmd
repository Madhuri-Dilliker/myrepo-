...
request_people
```
### Parsing the data from json format and converting it to dataframe format
...
People_data$peopleId <- gsub(".*films/", "", People_data$url)
People_data$peopleId  <-gsub("\\/.*","", People_data$peopleId  )
```
